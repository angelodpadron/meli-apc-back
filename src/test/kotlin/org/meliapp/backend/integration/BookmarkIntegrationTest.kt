...
class BookmarkIntegrationTest(
    ...
    @Test
    fun `should return list of bookmark and a 200 status code`() {
        makeAuthGetRequest("/api/bookmarks").andExpect(status().isOk)
    }

    @Test
    fun `should create a bookmark and a 201 status code`() {
        productRepository.save(Product().apply {
            meliId = "new_meli_id"
            title = "product_title"
            price = BigDecimal(1)
    ...
    @Test
    fun `should not create a bookmark for an non existing product and return a 400 status code`() {
    ...
    @Test
    fun `should return the details of a bookmark and a 200 status code`() {
    ...
    @Test
    fun `should delete a bookmark and return a 200 status code`() {
        mockMvc.perform(
    ...
    @Test
    fun `should not delete a non existing bookmark and return a 404 status code`() {
